...
\begin{document}
    ...
    {\fontsize{7.8pt}{8.5pt}\selectfont
        ...
        \lstinputlisting{Graphs/Directed Graphs/Euler.cpp}
        \subsection{Flows}
        \subsubsection{Dinic}
        \lstinputlisting{Graphs/Weighted Graphs/Dinic.cpp}
        \subsection{Matching}
        \subsubsection{Kuhn}
        \lstinputlisting{Graphs/Graphs/Kuhn.cpp}
        \subsection{Bicomponents}
        \lstinputlisting{Graphs/Graphs/2-edge-connectivity.cpp}
        \subsection{2SAT}
        \input{Graphs/Directed Graphs/2SAT.tex}

        \section{Structures}
        \subsection{DSU}
        \lstinputlisting{Structures/DSU.cpp}
        \subsection{RB Tree}
        \lstinputlisting{Structures/rb_tree.cpp}
        \subsection{Segment Trees}
        \subsubsection{Segment Tree 1}
        \lstinputlisting{Structures/Segment Tree/Segment Tree 1/Segment Tree 1.cpp}
        \subsubsection{Segment Tree 2}
        \lstinputlisting{Structures/Segment Tree/Segment Tree 2/Segment Tree 2.cpp}

        \section{Fast Fourier Transfrom}
        \subsection{FFT-998244353}
        \lstinputlisting{FFT/fft-998244353.cpp}
        \subsection{FFT complex double}
        \lstinputlisting{FFT/fft-complexdouble.cpp}

        \section{Strings}
        \subsection{Prefix function}
        \lstinputlisting{STRINGS/prefix_function.cpp}
        \subsection{z-function}
        \lstinputlisting{STRINGS/z_function.cpp}
        \subsection{Occurences}
        \lstinputlisting{STRINGS/occurences.cpp}
        \subsection{Shifts to combine}
        \lstinputlisting{STRINGS/shifts to combine.cpp}

        \section{Combinatorics}
        \subsection{Longest increasing subsequence}
        \lstinputlisting{combinatorics/LIS.cpp}
        \subsection{Manacher}
        \lstinputlisting{combinatorics/manacher.cpp}
        \subsection{Parity pf permutation}
        \lstinputlisting{combinatorics/parity_of_permut.cpp}

        \section{Geometry}
        \subsection{Basics}
        \lstinputlisting{Geometry/Basics Intersections.cpp}
        \subsection{Polygon Area}
        \lstinputlisting{Geometry/Polygon Area.cpp} 
        \subsection{Convex Hull}
        \lstinputlisting{Geometry/Convex Hull.cpp}  
        \subsection{In Polygon}
        \lstinputlisting{Geometry/In Polygon.cpp} 

        \section{Algebra}
        \subsection{Gauss}
        \lstinputlisting{Algebra/Gauss.cpp}

        \section{Helpful things}
        \subsection{output to file}
        \lstinputlisting{Helpful things/write_to_file.cpp} 
        \subsection{bitset}
        \lstinputlisting{Helpful things/bitset.cpp}
        \subsection{bound}
        \lstinputlisting{Helpful things/lwb.cpp}
        \lstinputlisting{Helpful things/uppb.cpp}
        \subsection{ternary search}
        \lstinputlisting{Helpful things/ternary search.cpp}
