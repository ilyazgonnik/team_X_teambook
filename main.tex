...
{\fontsize{7.8pt}{8.5pt}\selectfont
    \tableofcontents
    \newpage
    \lstinputlisting{starting/starting.tex}
    \lstinputlisting{rng/rng.tex}
    \section{Теория чисел}
    \lstinputlisting{Number Theory/fastpow/fastpow.tex}
    \lstinputlisting{Number Theory/Linear Sieve/Linear Sieve.tex}
    \lstinputlisting{Number Theory/factorization sqrt/factorization sqrt.tex}
    \lstinputlisting{Number Theory/Divisors/All divisors.tex}
}
    \newpage
\end{document}
