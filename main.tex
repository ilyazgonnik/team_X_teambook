...
{\fontsize{7.8pt}{8.5pt}\selectfont
    \tableofcontents
    \newpage
    \lstinputlisting[language=C++]{starting/starting.cpp}
    \lstinputlisting[language=C++]{rng/rng.cpp}
    \section{Теория чисел}
    \lstinputlisting[language=C++]{Number Theory/fastpow/fastpow.cpp}
    \lstinputlisting[language=C++]{Number Theory/Linear Sieve/Linear Sieve.cpp}
    \lstinputlisting[language=C++]{Number Theory/factorization sqrt/factorization sqrt.cpp}
    \lstinputlisting[language=C++]{Number Theory/Divisors/All divisors.cpp}
}
    \newpage
\end{document}
