...
\begin{document}
    ...
    {\fontsize{7.8pt}{8.5pt}\selectfont
        ...
        \subsection{bound}
        lower_bound(begin, end, value) is the first in $[begin, end)$ element that is $\geq$ value.
        upper_bound(begin, end, value) is the first in $[begin, end)$ element that is $\ge$ value.
